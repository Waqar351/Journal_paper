...
def get_training_scores(X_train, Y_train, nclasses):
    ...
    if nfolds > 1:
        ...
        for train, test in kfold.split(X_train, Y_train):
            X_trn, x_val, y_trn, y_val = train_test_split(X_train.iloc[train], Y_train.iloc[train], test_size = 0.5, stratify=Y_train.iloc[train])
